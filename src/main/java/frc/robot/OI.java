...
public class OI {
	...
	public static JoystickButton buttonB = new JoystickButton(controller2, 2);			//B button input
	public static JoystickButton buttonX = new JoystickButton(controller2, 3);			//X button input
