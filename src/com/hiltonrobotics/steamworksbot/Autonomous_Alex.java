...
public class Autonomous_Alex {								//Class that holds autonomous systems
	
	public Autonomous_Alex() {
	...
	public void RRAuto() {								//Auto for starting on the right and going for the right
		if(tick >= 10 && tick <= 15) {					//Forward
			OI.leftMotor.setSpeed(0.65);
			OI.rightMotor.setSpeed(-0.65);
